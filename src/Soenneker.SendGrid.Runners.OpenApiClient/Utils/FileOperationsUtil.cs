...
public sealed class FileOperationsUtil : IFileOperationsUtil
{
    ...
    public async ValueTask Process(CancellationToken cancellationToken = default)
    {
        ...
        string openApiRepositoryUrl = _configuration["SendGrid:OpenApiGitUrl"] ??
                                      _configuration["SendGrid:ClientGenerationUrl"] ??
                                      "https://github.com/twilio/sendgrid-oai";
        string repositorySubdirectory = _configuration["SendGrid:OpenApiRepositorySubdirectory"] ?? "spec/json";
        ...
        await _processUtil.Start("kiota", gitDirectory, $"kiota generate -l CSharp -d \"{fixedFilePath}\" -o src/{Constants.Library} -c SendGridOpenApiClient -n {Constants.Library}",
